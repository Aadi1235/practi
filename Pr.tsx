...
const Banner = () => {
  return (
    <div className="max-w-[327px] max-h-[950px] md:max-w-[1207px] max-h-[796px] mx-auto">
    <div className="relative md:w-[1207px] h-[796px] flex flex-col items-center align-center text-center gap-[30px] text-black font-montserrat bg-zinc-300">
      ...
      <div className="flex flex-col items-center justify-start text-lg mr-12 top-[12px] left-[24px] gap-[12px] ">
        <div className="w-[230px] h-[74px] md:w-[598px] md:h-[76px] rounded-md md:rounded-xl flex flex-col box-border">
          <div className="flex flex-row items-center justify-center gap-[32px]">
            <div className="w-[182px] h-[42px] flex flex-row items-start justify-start md:w-[252px] h-[52px] rounded-md">
              ...
              />
              <img
                className="w-[40px] h-[40px] relative rounded-[50%] md:w-[52px] md:h-[52px] object-cover md:ml-[-12px]"
                alt=""
                src="/ellipse-2.svg"
              />
              <img
              ...
              <img
                ...
                src="/ellipse-5.svg"
              />
              <div className="w-[40px] h-[40px] relative md:w-[52px] md:h-[52px]">
            ...
            <div className="relative w-[204px] h-[20px] align-center md:top-[10px] text-[16px] md:w-[280px] h-[28px] text-[22px] leading-[20.01%] font-medium montserrat text-[#000000]">
    ...
    <div className="flex flex-wrap w-[327px] h-[455px] justify-around gap-[16px] md:w-[1187px] md:h-[282px] md:flex md:flex-nowrap md:flex-row md:gap-[16px] text-left text-2xl text-black font-montserrat ">
       <div className="w-2/4 order-2 text-[20px] md:text-[32px] order-2 w-[158px] h-[180px] md:w-[283px] md:h-[282px] md:order-1 shadow-[0px_2px_25px_rgba(0,_0,_0,_0.05)] rounded-xl bg-white overflow-hidden shrink-0 flex flex-col items-end justify-start py-7 box-border">
       ...
       <div className="w-[320px] order-1 md:w-[589px] rounded-xl bg-[#F5F7FE] md:h-[279px] md:order-2 overflow-hidden shrink-0 flex flex-col items-center justify-start py-[23px] px-0 box-border text-3xl">
      ...
      <div className="relative w-2/4 order-3 w-[159px] h-[180px] md:w-[283px] md:order-3 rounded-xl bg-[#F5FFF6] md:h-[282px] overflow-hidden shrink-0 flex flex-col items-center justify-end box-border text-xs text-silver">
        <div className="flex flex-col items-center justify-start gap-[12px] md:gap-[32px]">
          <div className="w-[160px] h-[160px] md:w-[223px] relative md:h-[125px]">
            <div className="absolute top-[0px] object-cover w-[223px] h-[204px] flex flex-col items-center justify-end">
              <img
                className="w-[160px] h-[112px] md:w-[223px] relative md:h-[180px]"
                alt=""
                src="/group-31.svg"
              />
              <div className="w-10 relative h-[60px] md:h-[95px] mt-[-181px]">
                <img
                  className="absolute top-[50px] md:top-[20px] md:left-[16px] w-2 h-14"
                  alt=""
                  src="/group-27.svg"
                />
